                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            @endforelse
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3 cursor-pointer" data-modal-target="gambar-modal"
                                    data-modal-toggle="gambar-modal">
                                    <img src="../src/asset/image/ahmad.jpg" alt=""
                                        class="h-16 w-16 object-cover rounded-lg">
                                </td>
                                <td class="px-4 py-3 cursor-pointer" data-modal-target="file-modal"
                                    data-modal-toggle="file-modal">
                                    Lihat File
                                </td>
                                <td class="px-4 py-3 cursor-pointer" data-modal-target="audio-modal"
                                    data-modal-toggle="audio-modal">
                                    Lihat Audio
                                </td>
                                <td class="px-4 py-3 cursor-pointer" data-modal-target="video-modal"
                                    data-modal-toggle="video-modal">
                                    Lihat video
                                </td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="data1-dropdown-button" data-dropdown-toggle="data1-dropdown"
                                        class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                                        type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                            viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="data1-dropdown"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="data1-dropdown-button">
                                            <li>
                                                <a href="#"
                            ...
                            <!-- Modal gambar -->
                            <div id="gambar-modal" tabindex="-1" aria-hidden="true"
                            ...
                            <!-- Modal file -->
                            <div id="file-modal" tabindex="-1" aria-hidden="true"
                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-2xl max-h-full">
                                    <!-- Modal content -->
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <!-- Modal body -->
                                        <div class="p-4 md:p-5 space-y-4">
                                            <iframe src="../src/asset/Langkah-Install-Windows-10.pdf" width="600"
                                                height="400"></iframe>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Modal audio -->
                            <div id="audio-modal" tabindex="-1" aria-hidden="true"
                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-2xl max-h-full">
                                    <!-- Modal content -->
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 space-y-4">
                                            <audio controls class="w-full">
                                                <source src="../src/asset/audio.mpeg" type="audio/mpeg">
                                            </audio>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 space-y-4">
                                            <video class="h-80 w-full" controls>
                                                <source src="../src/asset/video/video.mp4" type="video/mp4">
                                            </video>
                                        </div>
                                    </div>
                                </div>
