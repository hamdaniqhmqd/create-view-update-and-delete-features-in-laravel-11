                            ...
                            @forelse ($dataTeks as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-3 py-2 flex items-center justify-end">
                                        <button id="{{ $data->id_text }}-button"
                                            data-dropdown-toggle="{{ $data->id_text }}-dropdown"
                                        ...
                                        <div id="{{ $data->id_text }}-dropdown"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $data->id_text }}-button">
                                                <li>
                                                    <button id="{{ $data->id_text }}Button"
                                                        data-modal-target="{{ $data->id_text }}update"
                                                        data-modal-toggle="{{ $data->id_text }}update" type="button"
                                ...
                                <div id="{{ $data->id_text }}update" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-modal-toggle="{{ $data->id_text }}update">
                                            ...
                                            <!-- Modal body -->
                                            <form action="{{ route('teks.update', $data->id_text) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                ...
                                <div id="{{ $data->id_text }}delete" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mx-auto z-50 justify-center items-center w-full inset-0 h-modal h-full">
                                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                        <!-- Modal content -->
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                    data-modal-toggle="{{ $data->id_text }}delete">
                                                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor"
                                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd"
                                                            d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                            ...
                                            <!-- Modal body -->
                                            <form action="{{ route('teks.delete', $data->id_text) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <div class="mb-4">
        ...
        <div id="addData" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('teks.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="grid gap-4 mb-4">
                            <div>
                                <label for="judul"
